// FAL AI Veo3 Fast Image-to-Video 모델을 사용한 비디오 생성
import { createClient } from '@supabase/supabase-js';
import jwt from 'jsonwebtoken';
import { fal } from '@fal-ai/client';

const VIDEO_GENERATION_COST = 2000; // Veo3 Fast 비용 (50% 할인된 가격)
...
export const handler = async (event) => {
  ...
  try {
    ...
    console.log('FAL AI Veo3 Fast video generation request:', {
      projectId,
      videoId,
    ...
    const generationId = `fal_veo3fast_${Date.now()}_${Math.random().toString(36).substring(7)}`;
    ...
    const { error: updateError } = await supabaseAdmin
      ...
      .update({
        ...
        model_version: 'fal-ai/veo3/fast/image-to-video',
        metadata: {
          ...requestBody,
    ...
    // FAL AI Veo3 Fast 비디오 생성 요청
    console.log('Requesting video generation with FAL AI Veo3 Fast...');
    ...
    try {
      ...
      console.log('FAL AI Veo3 Fast generation completed:', result.requestId);
      ...
      return {
        ...
        body: JSON.stringify({
          ...
          status: 'completed',
          videoUrl: result.data.video.url,
          message: 'FAL AI Veo3 Fast 비디오 생성이 완료되었습니다.',
          model: 'fal-ai/veo3/fast/image-to-video'
        })
      };
    ...
    console.error("Veo3 Fast Video Generation Error:", error);
