...
규칙:
1. 스크립트 상 스토리 전개에 필요한 주요 캐릭터를 추출(실제 인물이 없을 경우 보편적인 캐릭터도 포함)
2. "내레이터"는 제외
3. 기존 캐릭터 리스트에 있는 인물이면 정확히 동일한 이름 사용(시대와 국적을 잘 반영해서 적용해야함)
4. 캐릭터 이름과 특징을 함께 표기 - 예: "엘리자베스2세여왕(영국 여왕)", "김철수(회사원)", "할머니(70대)"
